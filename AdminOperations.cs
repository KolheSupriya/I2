                    ...
                    case 1:
                        {
                            ...
                            USERS data = new USERS() { Role_ID = roleId, User_Name = User_Name, First_Name = First_Name, Last_Name = Last_Name, Password = Password, City = City, Address = Address, Zip_Code = Zip_Code, Email = Email };
                            ctx.USERS.Add(data);
